...
call ReplaceURL.bat mdta http[s]*:\/\/www.ezpassmd.com http:\/\/int.ezpassmd.com
call ReplaceURL.bat maintenance_mdta http[s]*:\/\/www.ezpassmd.com http:\/\/int.ezpassmd.com
