...
call ReplaceURL.bat ny http[s]*:\/\/www.e-zpassny.com http:\/\/int.e-zpassny.com
call ReplaceURL.bat maintenance_ny http[s]*:\/\/www.e-zpassny.com http:\/\/int.e-zpassny.com
