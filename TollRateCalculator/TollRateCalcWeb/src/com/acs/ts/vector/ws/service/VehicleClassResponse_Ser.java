...
public class VehicleClassResponse_Ser extends com.ibm.ws.webservices.engine.encoding.ser.BeanSerializer {
    /**
     * Constructor
     */
    public VehicleClassResponse_Ser(
    ...
    protected void addElements(
        ...
        throws java.io.IOException
    {
        VehicleClassResponse bean = (VehicleClassResponse) value;
        java.lang.Object propValue;
        javax.xml.namespace.QName propQName;
        {
          propQName = QName_0_9;
          {
            propValue = bean.getVehicleClass();
            if (propValue != null) {
