...
public class EntryPointsResponse_Ser extends com.ibm.ws.webservices.engine.encoding.ser.BeanSerializer {
    /**
     * Constructor
     */
    public EntryPointsResponse_Ser(
    ...
    protected void addElements(
        ...
        throws java.io.IOException
    {
        EntryPointsResponse bean = (EntryPointsResponse) value;
        java.lang.Object propValue;
        javax.xml.namespace.QName propQName;
        {
          propQName = QName_0_4;
          {
            propValue = bean.getFacilities();
            if (propValue != null) {
