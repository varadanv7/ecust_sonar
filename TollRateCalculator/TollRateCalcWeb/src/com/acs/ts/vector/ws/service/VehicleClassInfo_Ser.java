...
public class VehicleClassInfo_Ser extends com.ibm.ws.webservices.engine.encoding.ser.BeanSerializer {
    /**
     * Constructor
     */
    public VehicleClassInfo_Ser(
    ...
    protected void addElements(
        ...
        throws java.io.IOException
    {
        VehicleClassInfo bean = (VehicleClassInfo) value;
        ...
        javax.xml.namespace.QName propQName;
        {
          ...
          propValue = bean.getVehicleClassDesc();
          if (propValue != null && !context.shouldSendXSIType()) {
            context.simpleElement(propQName, null, propValue.toString()); 
          } else {
            serializeChild(propQName, null, 
