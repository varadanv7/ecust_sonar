...
public class FacilityInfo_Ser extends com.ibm.ws.webservices.engine.encoding.ser.BeanSerializer {
    /**
     * Constructor
     */
    public FacilityInfo_Ser(
    ...
    protected void addElements(
        ...
        throws java.io.IOException
    {
        FacilityInfo bean = (FacilityInfo) value;
        ...
        javax.xml.namespace.QName propQName;
        {
          ...
          propQName = QName_0_7;
          propValue = bean.getFacilityName();
          if (propValue != null && !context.shouldSendXSIType()) {
            context.simpleElement(propQName, null, propValue.toString()); 
          } else {
            serializeChild(propQName, null, 
